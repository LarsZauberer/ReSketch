...
def train():
    with open("src/models/quickdraw_model/quickdraw_train.json", "r") as f:
        data = json.load(f)
    ...
    model.summary()
    model.save(r'src/models/quickdraw_model/model_hand.h5')
...
def test():
    with open("src/models/quickdraw_model/quickdraw_test.json", "r") as f:
        data = json.load(f)
    ...
    model.load_weights("src/models/quickdraw_model/model_hand.h5")
