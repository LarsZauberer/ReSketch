...
def train():
    with open("src/models/emnist_model/emnist_train.json", "r") as f:
        data = json.load(f)
    ...
    model.summary()
    model.save(r'src/models/emnist_model/model_hand.h5')
...
def test():
    with open("src/models/emnist_model/emnist_test.json", "r") as f:
        data = json.load(f)
    ...
    model.load_weights("src/models/emnist_model/model_hand.h5")
