...
from models.mnist_model.utils.layers import PrimaryCaps, FCCaps, Length
from models.mnist_model.utils.tools import get_callbacks, marginLoss, multiAccuracy
from models.mnist_model.utils.dataset import Dataset
from models.mnist_model.utils import pre_process_multimnist
from models.mnist_model.models import efficient_capsnet_graph_mnist, efficient_capsnet_graph_smallnorb, efficient_capsnet_graph_multimnist, original_capsnet_graph_mnist
import os
import json
...
class Model(object):
    ...
    save_graph_weights():
        save model weights
    """
    def __init__(self, model_name, mode='test', config_path='src/models/mnist_model/config.json', verbose=True):
...
class EfficientCapsNet(Model):
    ...
    """
    def __init__(self, model_name, mode='test', config_path='src/models/mnist_model/config.json', custom_path=None, verbose=True):
