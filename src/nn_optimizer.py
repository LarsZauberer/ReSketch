...
def create_runner(args):
    def runner(gamma, epsilon, alpha, replace_target, episode_mem_size, n_episodes, min_decrement=0.3, rec_reward=0.1):
        parameters = locals()
        global current_best
        ...
        agent_args = {"gamma": gamma, "epsilon": epsilon, "alpha": alpha, "replace_target": int(replace_target), 
                    ...
                    "mem_size": mem_size, "batch_size": batch_size, "model": "base-optimizer"}
