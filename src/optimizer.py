...
def runner(gamma, epsilon, alpha):
    ...
    agent_args = {"gamma": gamma, "epsilon": epsilon, "alpha": alpha, "replace_target": 1000, 
...
if __name__ == '__main__':
    ...
    parameters = {"gamma": (0.001, 0.99), "epsilon": (0.1, 1), "alpha": (0.0001, 0.001)}
