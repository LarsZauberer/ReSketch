...
def hyperparameter_loader(path: str, modelName: str):
    ...
    if hyp_data.get(modelName, False):
        ...
        hyp_data = {"gamma": 0.70, "epsilon": 0.3, "epsilon_episodes": 1000, "alpha": 0.0002, "replace_target": 6000, "episode_mem_size": 900, "n_episodes": 3000, "friction": 0.3, "vel_1": 0.9, "vel_2": 1.5} 
