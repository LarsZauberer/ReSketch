...
(siehe \autoref{tab:modelle}) vergleichbar. Die Tabellen \autoref{tab:MNIST}, \autoref{tab:EMNIST} und \autoref{tab:Quickdraw} zeigen
...
[ETH template] formatiert. Ein Grossteil der Abbildungen stammt von den Autoren
und ist in Adobe Illustrater [adobe ill] oder der Python Library Matplotlib
[matplotlib] erstellt
