...
Beantwortung der Fragestellung
	...
	• Wie lässt sich die Leistung der KI in ihrer Aufgabe beurteilen?
		...
		○ Beurteilung durch Erkennbarkeit. Ist Sonderfall, weil Verwendung von Classifier. Classifier nicht 100% Genau. Je nachdem falsche Beurteilung. Vor allem Problem, dass KI Dinge als erkennbar angibt, die für Grossteil der Menschen nicht erkennbar wären 
...
Fazit und Ausblick 
	...
	• Die Qualität der nachzeichnenden KI und der generativen KI hängt von der Verlässlichkeit der klassifizierenden KI ab, die im Training verwendet wird. Da diese nicht eine Genauigkeit von 100% erreicht, ist das Training nicht optimal. Ausserdem sind die Resultate im Kriterium der Erkennbarkeit durch die Imperfektion der klassifizierenden KI leicht verfälscht.
