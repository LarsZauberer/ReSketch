...
\doubleref{sub:m_var_phy}). Die physikalische Umgebung hat zum Ziel, die
...
der physikalischen Umgebung gezeichnet sind (siehe \doubleref{chap:r_bild}), gehen
...
\autoref{tab:models}) vergleichbar. Die Tabellen (siehe \doubleref{chap:r_tab})
...
realitätsgetreu (siehe \doubleref{subsub:d_frage_unter_4})
