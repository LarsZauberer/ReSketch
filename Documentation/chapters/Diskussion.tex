...
der acht Versionen (siehe \doubleref{chap:m_var}), bezogen auf die drei
definierten Kriterien (siehe \doubleref{chap:m_eval}). Die Daten in den Tabellen
stammen aus den Tests der KI (siehe \doubleref{chap:m_auswert}). Der Unterschied
...
Farbverlauf, der den zeitlichen Verlauf des Zeichnens darstellt. Die Helligkeit
...
Die Diskussion analysiert die Resultate der Methode (siehe \doubleref{chap:m}),
