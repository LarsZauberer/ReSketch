...
Menschen beim Zeichnen einer Zahl nachahmt. Einige Kriterien sind untereinander  % TODO: Zahl evt. ausbessern % BUG: Ruh
...
% Menschliches Zeichnen langsam. schreiben von Zahlen schnell. Erkennbarkeit über Genauigkeit. u.A weil so schneller. 
% Geschwindigkeit also wichtige Annäherung an Menschen.

% Für Training auf Geschwindigkeit muss das Kriterium einen numerischen Wert annehmen
% Bestimmt durch Anzahl Schritte bis fertig ist. dafür muss aber bestimmt werden, wann Zeichnung fertig ist.

% Zeichnung ist fertig, wenn Zahl nach der Definition im letzten kapitel erkannt wird und eine relative Genauigkeit von 60% erreicht.

\subsection*{Training auf Geschwindigkeit}

% Reward am Ende jeder Zeichnung für alle Schritte mit einem Faktor multipliziert
% Faktor Grösser, wenn Schneller (Formel für Berechnung) 1 + Schritte bis Fertigstellung/max Schritte
% Wenn Zeichnung nicht fertiggestellt wird (Anforderungen nicht erfüllt) -> Faktor = 1
% Die Zeichnung wird immer bis ans Ende ausgeführt. Der Schritt der Fertigstellung wird beim ersten Mal gespeichert, wenn das Kriterium erfüllt wird.
