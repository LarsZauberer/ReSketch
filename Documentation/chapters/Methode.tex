...
\doubleref{sub:t_rl_func}) stellen diese gewünschten Eigenschaften bereit. Das
Grundprogramm ist in Python unter der Verwendung des Keras Frameworks
implementiert (siehe \doubleref{chap:t_ml}). 
