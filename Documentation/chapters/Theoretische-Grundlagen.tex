...
\cite{arora_supervised_2020}. Beachte \doubleref{chap:t_rl} für eine ausgeprägtere
...
\begin{figure}[!ht]
    ...
    \caption{Prinzip einer Black Box Funktion \cite{noauthor_fileblackboxsvg_nodate}}\label{fig:blackbox}
\end{figure}
...
(siehe \doubleref{sub:t_ml_func}). Die inneren Vorgänge in der BlackBox Funktion
...
Beispielproblem (siehe \doubleref{chap:t_ml}) bestände die Eingabe-Ebene aus
...
neuronalen Netzes (siehe \doubleref{sub:t_ml_nn}). Der Input in dieses neuronale
...
Q-Learning (siehe \doubleref{sub:t_rl_func}), erlernt, Strichbilder aus dem Google
...
\doubleref{sub:t_rl_func}), ist in zwei Teile gegliedert: den Global Stream und
