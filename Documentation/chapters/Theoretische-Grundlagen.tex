...
75]{sutton_reinforcement_2014}. Umso grösser
...
Actions) addiert. Diese Formel nennt sich Bellman-Gleichung \cite[S. 3]{mnih_playing_nodate}. Der neue Q-Value hat somit einen kleineren Wert, wenn der Reward negativ ist, und einen
...
ist \emph{Stroke-Based Rendering} [stroke based rendering]. Stroke-Based % TODO: Quelle?
...
dafür ist das Programm Doodle-SDQ \cite{zhou_learning_2018}. Doodle-SDQ beschäftigt sich auch
spezifischer mit dem Nachzeichnen von Strichbildern und wird deswegen im
