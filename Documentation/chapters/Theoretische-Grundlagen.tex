...
Verhalten durch eine Maschine oder ein System'' [ZITAT] Mit Maschinen und                %Todo: Zitat quelle
...
Actions) addiert. Diese Formel nennt sich Bellman-Gleichung [DQN s.3]. Der neue Q-Value          % Todo Ref Bellman Gleichung, Ref Sutton-Barto
