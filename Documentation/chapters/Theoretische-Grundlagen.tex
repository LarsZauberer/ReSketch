...
\cite{arora_supervised_2020}. Beachte Abschnitt \doubleref{chap:t_rl} für eine
...
(siehe \doubleref{sub:t_ml_nn}) umfassen diese Funktionalität und finden daher in
...
\begin{figure}[!ht]
    ...
    \caption{Prinzip einer Black Box Funktion \cite{noauthor_black_2021}}
    \label{fig:blackbox}
\end{figure}
...
Modelles (siehe \doubleref{sub:t_ml_func}). Die inneren, nicht betrachteten
...
(siehe \doubleref{sub:t_ml_nn}). Der Input in dieses neuronale Netz ist die
...
\begin{figure}[!ht]
    ...
    \caption{Funktionsweise eines Reinforcement Learning Modelles (eigene Abbildung)}\label{fig:reinforce-1}
\end{figure}
...
spezifischer Deep Q-Learning (siehe \doubleref{sub:t_rl_func}) erlernt,
