...
nachzeichnenden KI basiert, entfernt sich von der ursprünglichen Aufgabe und
erlernt das Zeichnen von Strichbildern ohne eine Vorlage, solange diese im
Training mit verschiedenen Vorlagen eines gewünschten Motivs trainiert hat.
Diese KI entwickelt dabei gewissermassen eine eigene Handschrift, die auf
Beispielen von tausenden anderen Handschriften basiert.
\end{abstract}
